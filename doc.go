...
See the github.com/michaelcheah/go-elasticsearch/esapi package for more information about using the API.

See the github.com/michaelcheah/go-elasticsearch/estransport package for more information about configuring the transport.
*/
